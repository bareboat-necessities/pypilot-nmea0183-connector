...
int main() {
    ...
    assert(!optional.apply_optional_sentence(s, model, 10, SensorSource::serial));

    optional.set_enable_optional_inputs(true);
    assert(optional.apply_optional_sentence(s, model, 20, SensorSource::serial));
    ...
    assert(optional.apply_optional_sentence(s, model, 30, SensorSource::serial));
    ...
    assert(optional.apply_optional_sentence(s, model, 40));
    ...
    assert(optional.apply_optional_sentence(s, model, 50));
    ...
    assert(optional.apply_optional_sentence(s, model, 60, SensorSource::serial));
    ...
    assert(optional.apply_optional_sentence(s, model, 70, SensorSource::serial));
    ...
    assert(optional.apply_optional_sentence(s, model, 80, SensorSource::serial));
